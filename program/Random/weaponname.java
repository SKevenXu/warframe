...
public class weaponname {
    public String ReadGsonTest(int num) {
        String name_url=null;
        Gson gson = new Gson();
        String reader=readJsonData("program\\rivenSearch\\weapon.json");
    ...
    //循环遍历
        ...
        //通过反射 得到UserBean.class
           ...
           /*  mainLView.setAdapter(new UserAdapter(this, userBeanList)); */
                ...
                /* System.out.println("num="+num+"items_name:"+it.get(num).item_name);
                System.out.println("items_url:"+it.get(num).url_name);
                System.out.println("hashcode="+it.get(num).item_name.hashCode()); */
                name_url=it.get(num).item_name;
